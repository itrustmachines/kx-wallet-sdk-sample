...
import { getParametersValue, bufferToHexCodes, clearProps } from "../../external/pvutils/utils.js";
import { getEngine } from "../../external/PKI.js/common.js";
import PublicKeyInfo from "../../external/PKI.js/PublicKeyInfo.js";
import RelativeDistinguishedNames from "../../external/PKI.js/RelativeDistinguishedNames.js";
...
export default class CertificationRequest
{
	...
	sign(privateKey, hashAlgorithm = "SHA-1")
	{
		...
		sequence = sequence.then(() => privateKey.rsaSignPKCS1v15(this.tbs));
