...
import { getParametersValue, utilConcatBuf, isEqualBuffer, clearProps } from "../../external/pvutils/utils.js";
import { getCrypto, getEngine, getOIDByAlgorithm, getAlgorithmByOID } from "../../external/PKI.js/common.js";
import AlgorithmIdentifier from "../../external/PKI.js/AlgorithmIdentifier.js";
...
import CertificateRevocationList from "../../external/PKI.js/CertificateRevocationList.js";
import OtherRevocationInfoFormat from "../../external/PKI.js/OtherRevocationInfoFormat.js";
import SignerInfo from "../../external/PKI.js/SignerInfo.js";
import CertificateSet from "../../external/PKI.js/CertificateSet.js";
import RevocationInfoChoices from "../../external/PKI.js/RevocationInfoChoices.js";
import IssuerAndSerialNumber from "../../external/PKI.js/IssuerAndSerialNumber.js";
import TSTInfo from "../../external/PKI.js/TSTInfo.js";
import CertificateChainValidationEngine from "../../external/PKI.js/CertificateChainValidationEngine.js";
import BasicOCSPResponse from "../../external/PKI.js/BasicOCSPResponse.js";
//**************************************************************************************
/**
 * Class from RFC5652
 */
export default class SignedData 
{
	...
	sign(privateKey, signerIndex, hashAlgorithm = "SHA-1", data = (new ArrayBuffer(0)))
	{
		...
		sequence = sequence.then(() => privateKey.rsaSignPKCS1v15(data));
